...
//require '../views/manage-students.view.php';
...
<html>
    <head>
        ...
        function loadDoc() {
            ...
            xhttp.open("GET", "search.php?q="+name, true);
            xhttp.send();
        }
            ...
            <div class="main">
                <div class="search-panel">
                    <form method="post" name="form2">
                        <ul>
                            <li><input type="text" name="searchBar" id="searchBar" placeholder="Search By ID or User Name" onkeyup="get_name(document.form2.searchBar.value)"></li>
                            <li><input class="btn-default" type="submit" name="search" value="Search"></li>
                        </ul>
                    </form>
                    <div id="chat">
                            asdfasdfasdfsadfsdfasdfsad
                    </div>
                </div>
